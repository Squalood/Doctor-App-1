          ...
          <div className="order-1 lg:order-2 lg:sticky lg:top-24">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-2 mb-4">
                <button className="flex items-center justify-center gap-2 p-3 rounded-lg bg-secondary text-secondary-foreground font-medium text-sm border-2 border-primary transition-all hover:bg-primary hover:text-primary-foreground">
                  <Building className="w-4 h-4" />
                  Presencial
                </button>
                <button className="flex items-center justify-center gap-2 p-3 rounded-lg bg-muted text-muted-foreground font-medium text-sm border-2 border-transparent transition-all hover:border-border">
              ...
              */}
              ...
              <p className="text-xs text-center text-muted-foreground">
                <span className="inline-flex items-center gap-1">
                  ...
                  Medical Agent asignado • Slots limitados esta semana
                </span>
              </p>
            </div>
          </div>
