      ...
      <div className="container-custom">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          {stats.map((stat, index) => (
            <StatItem key={index} {...stat} isVisible={isVisible} delay={index * 150} />
          ))}
        </div>
      </div>
    </section>
...
const StatItem = ({ icon: Icon, value, suffix = "", label, isNumber, isVisible, delay }: StatItemProps) => {
